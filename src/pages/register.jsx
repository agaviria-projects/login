          ...
          <h1 className="text-primary my-5">Formulario de Registro</h1>
            ...
            <form onSubmit={handleSubmit(onSubmited)} className='bg-light-subtle'>
                    <div className="mb-3">
                        ...
                        <input type="email"{...register("nombre",{required: true})} className="form-control" />
                    ...
                    <div className="mb-3">
                        ...
                        <input type="password" {...register("Confirmar_contrasena",{required: true})} className="form-control"/>
                        {errors.Confirmar_contrasena && <p className='text-danger'> Confirme la contraseña es obligatoria</p>}
                    </div>
